	...
	<div class="row">
		<div class="col-md-3" style="margin: 25px">
			<div class="card bg-light" style="width: 300px">
				<div class="card-header">Livres Empruntés</div>
				<div class="card-body">
					<p class="card-text">N° de livres empruntés: <?php echo get_user_issue_book_count();?></p>
					<a class="btn btn-success" href="view_issued_book.php">Voir les livres empruntés</a>
				</div>
			</div>
		</div>
