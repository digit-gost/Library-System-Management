...
<body>
		...
		<div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav navbar-center">
		      ...
		      <li class="nav-item dropdown">
	        	...
	        	<div class="dropdown-menu">
	        		<a class="dropdown-item" href="add_cat.php">Ajouter une nouvelle catégorie</a>
	        		<div class="dropdown-divider"></div>
		      ...
		      <li class="nav-item dropdown">
	        	...
	        	<div class="dropdown-menu">
	        		<a class="dropdown-item" href="add_author.php">Ajouter un nouvel auteur</a>
	        		<div class="dropdown-divider"></div>
    ...
    <span><marquee>Bienvenue dans le Système de Librairie Virtuelle. La librarie ouvre à at 8:00 du matin et ferme à 20:00 </marquee></span><br><br>
		<center><h4>Ajouter un auteur</h4><br></center>
		<div class="row">
			...
			<div class="col-md-4">
				<form action="" method="post">
					...
					<button type="submit" name="add_author" class="btn btn-primary">Ajouter l'auteur</button>
				</form>
			</div>
			<div class="col-md-4"></div>
		</div>
