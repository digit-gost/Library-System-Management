					...
					<?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn"><a href="edit_cat.php?cid=<?php echo $row['cat_id'];?>">Modifier🖍️</a></button>
								<button class="btn"><a href="delete_cat.php?cid=<?php echo $row['cat_id'];?>">Supprimer❌</a></button></td>
							</tr>
							<?php
						}
					?>
